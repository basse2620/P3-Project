...
async function changeBrugerEmail(bruger) {
  try {
    ...
    let updateBruger = await pool.request()
      ...
      .query("Update Bruger Set email = @email Where PK_brugernavn = @brugernavn");
    return updateBruger.recordsets;
  }
  catch (err) {
    console.log(err);
...
module.exports = {
  ...
  getBruger: getBruger,
  addBruger: addBruger,
  changeBrugerPassword: changeBrugerPassword,
  changeBrugerEmail: changeBrugerEmail,
